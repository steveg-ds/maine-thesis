\documentclass{maine-thesis}[apa]  % Default options 12pt and final copy
...
\renewcommand{\cfttoctitlefont}{\hfil\bfseries\centering}
...
\degreesheld{A.A.S., Bossier Parish Community College, 2019 \\ B.A., Louisiana Tech University, 2021}			% Previously earned degree(s), institution(s) and year(s).  
...
\singlespacing % Adjust spacing as needed (e.g., \doublespacing, \onehalfspacing)
