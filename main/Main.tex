...
\cftsetindents{figure}{3em}{10em} % Adjust the second value to set the desired space
...
\principaladvisor[TBD]{Matt Dube, Assistant Professor of Computer Information Systems} 			% Advisor's [short title and name]{name, long title}
