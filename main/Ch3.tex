...
\begin{table}[htbp]
    \centering
    \caption{Description of RUCA Codes Used}
...
This statistic ranges from -1 (perfect dispersion) to 1 (perfect clustering), where positive values indicate positive spatial autocorrelation (clustering), negative values indicate negative spatial autocorrelation (dispersion), and values around zero indicate randomness or no spatial pattern.
